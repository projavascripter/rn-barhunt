...
const initialUrl = 'https://www.scavengerhunt.com/app/register_large_group.php?ios=true';
let url = '';

class RegistrationLargeGroup extends Component {
...
export default RegistrationLargeGroup;
